...
<div ng-controller="AffiliationCtrl">
	...
	<@orcid.checkFeatureStatus 'DISPLAY_NEW_AFFILIATION_TYPES'>
		...
		<div id="workspace-education" class="workspace-accordion-item workspace-accordion-active" >
	        <#include "includes/affiliate/education_and_qualification_section_header_inc.ftl" />
			<div ng-if="workspaceSrvc.displayEducationAndQualification" class="workspace-accordion-content">
				<#include "includes/affiliate/education_and_qualification_body_inc.ftl" />
			</div>
		</div>
